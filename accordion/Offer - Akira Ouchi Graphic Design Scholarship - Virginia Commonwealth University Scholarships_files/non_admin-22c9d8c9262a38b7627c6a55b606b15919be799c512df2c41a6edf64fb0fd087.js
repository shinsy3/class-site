...
TextileEditor.Methods = {
  ...
  initialize: function(canvas, view) {
    ...
    for(var i = 0; i < edButtons.length; i++) {
      ...
      if (thisButton.classList.contains("f-textarea__toolbar-button--text")) {
        rightDiv.appendChild(thisButton);
  ...
  prepareButton: function(button) {
    ...
    var pathMap = {
      "bold.png"         : "https://d3p7lpwx08uxcm.cloudfront.net/assets/textile-editor/bold-445cef922112e18137d95ccfbc73b0025309025ea45148dacbc0778adfedcbb2.png",
      "italic.png"       : "https://d3p7lpwx08uxcm.cloudfront.net/assets/textile-editor/italic-91e576e1d3ad0529754af37d11062863c2c7490691eeac31b213c3eebdc4684e.png",
      "underline.png"    : "https://d3p7lpwx08uxcm.cloudfront.net/assets/textile-editor/underline-0be9313705f54c5b7303408f2ddbc5c72bc7fb766fcbffba49022dbfb3bfe31f.png",
      "list_numbers.png" : "https://d3p7lpwx08uxcm.cloudfront.net/assets/textile-editor/list_numbers-9cacc40ef442454a1a174067d85b744ffd859d36a03c6f8c3ed7816634448438.png",
      "list_bullets.png" : "https://d3p7lpwx08uxcm.cloudfront.net/assets/textile-editor/list_bullets-339c0d51eaf6779fc663c06c0ff258a9263a9635b7cb0e963ff6277dbb3007b0.png"
    }
...
;(function( $, window, document, undefined ){
    ...
    setTimeout( _.bind( function(){
      ...
      if ( this.options.focusInput ){
        $input = this.$modal
                  ...
                  .eq( 0 );
        if ( !$input.hasClass( "js-date" )) $input.focus();
      }
    }, this ), 0 );
  ...
  Plugin.prototype.checkKeyPress = function( e ){
    var isTabKey = e.keyCode === 9,
        isCloseKey = e.keyCode === 27,
        $currentEl = this.$modal.find(e.target),
        isCurrentElInModal = $currentEl.length < 1;

    if ( isTabKey && isCurrentElInModal ) {
      this.$modal.find( ".js-close" ).focus();
    }
...
;(function(){
  ...
  InputWordLimit.prototype.updateWordCount = function(){
    var $countSelector = this.$el.parent().find( ".js-current-word-count" ),
      ...
      isOverMaxCount ? $countSelector.addClass( "error-text" ) : $countSelector.removeClass( "error-text" );
  }
...
;(function(){
  ...
  Popover.prototype.showPopover = function( e ){
    ...
    this.$popover.width(popoverWidth)
                 ...
                 .on( "keydown", "a, input", { context : this }, this.moveFocus )
  ...
  Popover.prototype.moveFocus = function( e ){
    ...
    var thiz          = e.data.context,
        forwardKeys   = [9, 40],
        movingForward = !e || _.include( forwardKeys, e.keyCode ),
        movingBack    = e && ( e.keyCode === 38 || ( e.shiftKey && e.keyCode == 9 )),
        nextIndex;
    
    for ( var i = 0, len = thiz.$tabbables.length; i < len; i++ ){
      if ( thiz.$tabbables.eq( i ).is( this )) {
        nextIndex = i + ( movingBack ? -1 : 1 );
        break;
      }
    }
    
    thiz.focusOn( nextIndex );
  };
...
;(function(){
  ...
  Tabs.prototype.navigateTo = function( to ){
    ...
    $tabLink.closest( ".tab" ).attr( "aria-selected", true ).attr( "role", "tab");
  };
  ...
  Tabs.prototype._emptyTabState = function(){
    _.each( this.tabContentPairs, function( tabContentPair ){
      ...
      tabContentPair.link.closest(".tab").attr("aria-selected", false).attr("role", "tab");
  ...
  Tabs.prototype._bindTabsToContent = function( $nav, $content ){
    ...
    $links.each( function( index ){
      ...
      $this.attr({ href : "#" + newAnchor, "data-tab-pair-index" : index });
    });
  };
...
; (function () {
    ...
    return Billfold.NavigationSkipper = NavigationSkipper;
...
;(function(){
  ...
  ReviewerReviews.prototype.updateBookmarkCell = function ( $bookmarkCell, isBookmarked ) {
    ...
    if ( isBookmarked ) {
      imageAttributes = {
        src : "https://d3p7lpwx08uxcm.cloudfront.net/assets/flagged-full-c7de6d7624819a33c7717ee318a3e4e6f76765ccf841b916cce361b48844cee0.png",
        alt : "Flagged Icon",
      ...
      imageAttributes = {
        src : "https://d3p7lpwx08uxcm.cloudfront.net/assets/empty-bookmark-icon-38adae7f1085280ad3dca65fb2dd3aea05a97a13698e7c9733c3408db1268a8d.png",
        alt : "Unflagged Icon",
